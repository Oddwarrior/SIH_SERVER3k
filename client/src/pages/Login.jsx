    ...
    return (
        <div className="flex flex-col w-full h-screen  pt-[5%] items-center font-inter text-text-primary  text-sm">
            <section className=' flex flex-col justify-center gap-6 p-6 text-center'>
                ...
                <h1 className=' text-lg font-bold text-accent'>LOGIN</h1>
            </section>
            ...
            <Link to="/register" className=' text-center  text-accent font-semibold  hover:text-green-800 duration-300'>Click here to Regiter </Link>
        </div>
    );
}
